...
public class DBLib {
    private static WeakHashMap<JavaPlugin, DBLib> instances = new WeakHashMap<>();
    ...
    public static synchronized DBLib of(JavaPlugin plugin, DBLibConfig config, StorageTemplate storage) {
    ...
    public static synchronized DBLib of(JavaPlugin plugin) {
        return instances.getOrDefault(plugin, null);
    }
